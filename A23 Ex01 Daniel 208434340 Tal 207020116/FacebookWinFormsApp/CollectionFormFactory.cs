        ...
        public static Form CreateForm(User i_LoggedInUser, eCollectionFormType i_FormType)
        {
            ...
            switch (i_FormType)
            {
                case eCollectionFormType.FriendsForm:
                    form = new FormFacebookCollection<User>(new GenericFacebookObjectCollection<User>(i_LoggedInUser.Friends));
                ...
                case eCollectionFormType.AlbumsForm:
                    form = new FormFacebookCollection<Album>(new GenericFacebookObjectCollection<Album>(i_LoggedInUser.Albums));
